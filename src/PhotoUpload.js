...
const PhotoUpload = ({ onBack, onScanComplete }) => {
  ...
  const handleScan = async () => {
    ...
    try {
      ...
      const bloodTypeResult = await classifyBloodTypeFromFrame(selectedImage, apiResult).catch((err) => {
  ...
  return (
    <div className="photo-upload-container">
      <div className="upload-card">
        ...
        <p className="upload-instruction">Please drag or input your photo here</p>
